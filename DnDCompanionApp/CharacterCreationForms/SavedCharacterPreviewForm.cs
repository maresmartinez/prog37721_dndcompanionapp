...
namespace CharacterCreationForms {
    public partial class SavedCharacterPreviewForm : Form {
        Character character;

        public SavedCharacterPreviewForm(Character character) {
            InitializeComponent();
            this.character = character;
        }

        private void SavedCharacterPreviewForm_Load(object sender, EventArgs e) {
