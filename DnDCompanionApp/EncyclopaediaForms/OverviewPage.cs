...
namespace EncyclopaediaForms {
    public partial class OverviewPage : UserControl {
        ...
        /// <summary>
        /// Holds all the races in the database
        /// </summary>
        List<Race> allRaces = new List<Race>();

        /// <summary>
        /// Holds all classes in the database
        /// </summary>
        List<Class> allClasses = new List<Class>();

        /// <summary>
        /// Holds all the backgrounds in the database
        /// </summary>
        ...
        private void OverviewPage_Load(object sender, EventArgs e) {
            ...
            foreach (Race race in allRaces) {
                flowRaces.Controls.Add(new RaceTeaser(race));
            }

            foreach (Class charClass in allClasses) {
                flowClasses.Controls.Add(new ClassTeaser(charClass));
            }

            foreach (Background background in allBackgrounds) {
                flowBackgrounds.Controls.Add(new BackgroundTeaser(background));
            }
        }
